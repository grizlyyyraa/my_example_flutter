...
List<Map> schemes = [
  {
    ...
    "platforms": {
      "@type": "pubspecMyExampleFlutterPlatforms",
      "android": null,
      "ios": null,
      "linux": null,
      "macos": null,
    ...
    "environment": {
      "@type": "pubspecMyExampleFlutterEnvironment",
      "sdk": ">=2.18.5 <3.0.0",
    },
    "dependencies": {
      "@type": "pubspecMyExampleFlutterDependencies",
      "flutter": {
        "@type": "pubspecMyExampleFlutterDependenciesExtra",
        "sdk": "flutter",
      },
    ...
    "dev_dependencies": {
      ...
      "test": "^1.16.0",
      "packagex": {
        "@type": "pubspecMyExampleFlutterDevDependenciesExtra",
        "path": "../",
      },
      "msix": "^1.0.6"
    },
