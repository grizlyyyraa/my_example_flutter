...
import 'package:my_example_flutter_dart/api/my_example_flutter_dart_api_core.dart';
import 'package:universal_io/io.dart';

Logger logger = Logger();

Future<void> packageFullTemplateDartCli(List<String> args_raw) async {
  MyExampleFlutterDartApi packageFullTemplateDartApi = MyExampleFlutterDartApi();
  ...
  MyExampleFlutterDartBuildType server_universeDartBuildType = MyExampleFlutterDartBuildType.release;

  if (args.contains("--debug")) {
    server_universeDartBuildType = MyExampleFlutterDartBuildType.debug;
  }
