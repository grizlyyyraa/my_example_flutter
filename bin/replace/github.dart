...
git init
git branch -M main
git remote add origin https://github.com/grizlyyyraa/my_example_flutter
git remote set-url --push origin https://grizlyyyraa:{main_github_token}@github.com/grizlyyyraa/my_example_flutter
